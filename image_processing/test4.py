...
def findContours_img(original_img, opened):
    contours, hierarchy = cv2.findContours(opened.copy(), cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
...
if __name__ == "__main__":
    input_dir = r"C:\Users\zy199\Desktop\fc25e8ed0ae709ab91486b160e1c9144.jpeg"
    ...
    cv2.namedWindow('RedThresh', cv2.WINDOW_NORMAL)
